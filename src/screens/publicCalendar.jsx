...
export function PublicCalendar({ username }) {
  ...
  return <div className="min-h-screen bg-[#F5F6F8] text-slate-950"><CalendarView theme="light" profile={data.profile} schedule={{ events: data.events, period: data.period }} timeZone={timeZone} includeManualEventsInPdf={data.includeManualEventsInPdf} showRestDayEvents readOnly onToggleSlabTimes={() => {}} /></div>;
}
